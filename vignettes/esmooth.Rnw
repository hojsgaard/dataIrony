...
%\VignetteIndexEntry{esmooth: Exponential smoothing}
...
\def\code#1{\texttt{#1}}
\def\pkg#1{{\bf #1}}
\def\esmooth{\pkg{esmooth}}
\def\R{\texttt{R}}

<<echo=FALSE>>=
require(esmooth)
prettyVersion <- packageDescription("esmooth")$Version
prettyDate <- format(Sys.Date())
@


\title{Exponential smoothing in the \esmooth\ package}
\author{S{\o}ren H{\o}jsgaard}
\date{\pkg{esmooth} version \Sexpr{prettyVersion} as of \Sexpr{prettyDate}}
